...
import { FaSun, FaMoon } from 'react-icons/fa'; // Import icons for day and night
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-evenly" }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', backgroundColor: theme === 'dark' ? 'grey' : '#D4F1F4', borderRadius: '50px' }}>
          <Switch
            ...
            height={24}  // Adjust the height for smaller size
            width={48}   // Adjust the width for smaller size
            handleDiameter={20}  // Adjust the handle size
            boxShadow="0px 0px 2px 3px #999" // Circular border shadow
